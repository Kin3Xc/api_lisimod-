...
exports.addOneService = function(req, res){
	...
	Usuario.findOne({_id: req.body.userId}, function(err, data){
		...
		var mailOptions = {
			...
			text: 'Nuevo servicio',
			html: "<h1 style='color: #c0392b;'>Nuevo servicio en Domisil.co</h1> <p style='color:#7f8c8d;'>Su servicio se ha enviado correctamente, pronto nos pondremos en contacto con usted. <br><br> <h2>Detalles del Servicio</h2><p style='padding:0; margin:0;'>Tipo de Servicio: "+ req.body.tipoServicio +" </p> <p style='padding:0; margin:0;'>Origen: "+req.body.dirOrigen+" </p> <p style='padding:0; margin:0;'>Destino: "+req.body.dirDestino+" </p> <p style='padding:0; margin:0;'>Ciudad: "+req.body.ciudad+" </p> <p style='padding:0; margin:0;'>Estado: "+req.body.estadoService+" </p> <p style='padding:0; margin:0;'>Valor: "+req.body.valorPedido+"</p> <p style='padding:0; margin:0;'>Comentario "+req.body.comentario+" </p> <br><br><br> Cordialmente, <br>Equípo Domisil <br> Bogotá - Colombia <br> <a href='http://www.domisil.co'>Domisil.co</a></p>"
